...
from test4_question7_window import Test4_Question7_Window
...
class Test4_Question6_Window(QtWidgets.QMainWindow, QPushButton):
    ...
    def initUI(self):
        ...
        self.test4_question7_window = Test4_Question7_Window(self)
    def a_click(self):
        self.test4_question7_window.show()
        user_name = self.name_label.text()
        self.test4_question7_window.name_label.setText(user_name)
