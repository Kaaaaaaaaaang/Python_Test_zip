...
from test4_question10_window import Test4_Question10_Window
...
class Test4_Question9_Window(QtWidgets.QMainWindow, QPushButton):
    ...
    def initUI(self):
        ...
        self.test4_question10_window = Test4_Question10_Window(self)
    def a_click(self):
        self.test4_question10_window.show()
        user_name = self.name_label.text()
        self.test4_question10_window.name_label.setText(user_name)
