...
from test4_question5_window import Test4_Question5_Window
...
class Test4_Question4_Window(QtWidgets.QMainWindow, QPushButton):
    ...
    def initUI(self):
        ...
        self.test4_question5_window = Test4_Question5_Window(self)
    def a_click(self):
        self.test4_question5_window.show()
        user_name = self.name_label.text()
        self.test4_question5_window.name_label.setText(user_name)
