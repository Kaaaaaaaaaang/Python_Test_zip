...
from test4_question3_window import Test4_Question3_Window
...
class Test4_Question2_Window(QtWidgets.QMainWindow, QPushButton):
    ...
    def initUI(self):
        ...
        self.test4_question3_window = Test4_Question3_Window(self)
    def a_click(self):
        self.test4_question3_window.show()
        user_name = self.name_label.text()
        self.test4_question3_window.name_label.setText(user_name)
