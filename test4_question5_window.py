...
from test4_question6_window import Test4_Question6_Window
...
class Test4_Question5_Window(QtWidgets.QMainWindow, QPushButton):
    ...
    def initUI(self):
        ...
        self.test4_question6_window = Test4_Question6_Window(self)
    def a_click(self):
        self.test4_question6_window.show()
        user_name = self.name_label.text()
        self.test4_question6_window.name_label.setText(user_name)
