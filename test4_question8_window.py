...
from test4_question9_window import Test4_Question9_Window
...
class Test4_Question8_Window(QtWidgets.QMainWindow, QPushButton):
    ...
    def initUI(self):
        ...
        self.test4_question9_window = Test4_Question9_Window(self)
    def a_click(self):
        self.test4_question9_window.show()
        user_name = self.name_label.text()
        self.test4_question9_window.name_label.setText(user_name)
